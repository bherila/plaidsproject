...
<div id="content">
	...
	<!-- begin featured news -->
	<div class="featured">
	<h2>Founded by Ivy League Alliance (Brown University alum & Harvard University alum)</h2>
	<div id="featured">
	<?php
		$tmp_query = $wp_query;
    ...
    <p class="category"><?php the_category('No Category'); ?></p>

	
	<p class="comments"><?php comments_popup_link('No Comments'); ?></p>
	</div>
    </div>
	<!-- end post -->
